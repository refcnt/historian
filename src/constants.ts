...
export const CONTINENT_VIEWPORTS: Record<string, { latitude: number; longitude: number; zoom: number }> = {
...
export const CONTINENT_NAMES = Object.keys(CONTINENT_VIEWPORTS).filter(k => k !== 'World')
